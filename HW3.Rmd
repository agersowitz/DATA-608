...
set.seed(1003)
training_partition <- createDataPartition(train$target, p=0.7, list = FALSE, times=1)
train <- tr[training_partition, ]
test <- tr[-training_partition, ]
...
We find the stepwise model to be 93.18% accurate, have a very low p-value and auc = 0.99647.
